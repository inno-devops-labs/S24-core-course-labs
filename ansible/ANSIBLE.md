...
TASK [web_app : Update Nginx config from template] *********************************************************************************************************************************************************
--- before
+++ after: /home/wilson/.ansible/tmp/ansible-local-61421zipsajm6/tmpu6s4myzk/nginx.conf.j2
@@ -0,0 +1,8 @@
+server {
+    listen 80;
+    listen [::]:80;
...
PLAY RECAP *************************************************************************************************************************************************************************************************
ec2-34-204-94-32.compute-1.amazonaws.com : ok=19   changed=4    unreachable=0    failed=0    skipped=6    rescued=0    ignored=0   
```
