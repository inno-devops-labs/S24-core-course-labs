...
Running `ansible-playbook playbooks/dev/app_python/main.yml -i inventory/inventory.yml --skip-tags "wipe" --diff`, I get:
```shell
...
changed: [212.113.123.126]

TASK [web_app : Copy docker-compose file] ******************************************************************************************************************************************************************************************
--- before
+++ after: /home/dirakon/.ansible/tmp/ansible-local-82011x21o2zdr/tmpqi3kwlcm/docker-compose.yml.j2
@@ -0,0 +1,5 @@
+services:
+  web_app:
+    image: "dirakon/devops-py:latest"
+    ports:
+      - "8089:80"
...
PLAY RECAP *************************************************************************************************************************************************************************************************************************
212.113.123.126            : ok=12   changed=3    unreachable=0    failed=0    skipped=1    rescued=0    ignored=0   
```

After that, I can see (manually), that the app is indeed running via docker.

To deploy csharp app also, I run `ansible-playbook playbooks/dev/app_csharp/main.yml -i inventory/inventory.yml --skip-tags "wipe" --diff`:

```shell

PLAY [Deploy CSharp app] ***********************************************************************************************************************************************************************************************************
...
TASK [web_app : Copy docker-compose file] ******************************************************************************************************************************************************************************************
--- before
+++ after: /home/dirakon/.ansible/tmp/ansible-local-83207x28517mj/tmp0cuupyy7/docker-compose.yml.j2
@@ -0,0 +1,5 @@
+services:
+  web_app:
+    image: "dirakon/devops-cs:latest"
+    ports:
+      - "8087:8080"
\ No newline at end of file
...
And now, I firstly clean python app via `ansible-playbook playbooks/dev/app_python/main.yml -i inventory/inventory.yml --tags "wipe" --diff`:
...
TASK [web_app : Remove created files] **********************************************************************************************************************************************************************************************
--- before
+++ after
@@ -1,10 +1,4 @@
 {
...
PLAY RECAP *************************************************************************************************************************************************************************************************************************
212.113.123.126            : ok=3    changed=2    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0   

```

After that, I can see (manually), that the app is indeed stopped, and the folder is removed.

After, I clean csharp app via `ansible-playbook playbooks/dev/app_csharp/main.yml -i inventory/inventory.yml --tags "wipe" --diff`:
...
The app is stopped, the directory is removed.