...
```bash
$ kubectl create secret generic top-secret --from-literal=username=engaezik --from-literal=password=secret-pwd
...
{"password":"c2VhjkV0LXB3ZA==","username":"cmVraGjikg=="}
```

```bash
$ echo 'c2VhjkV0LXB3ZA==' | base64 --decode
...
app-python-86dbg557cc-pghsf   1/1     Running     0          17m
...
data: map[password:secret-pwd username:engaezik]
