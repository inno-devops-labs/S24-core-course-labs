...
NAME: vault
LAST DEPLOYED: Tue Apr 30 20:50:08 2024
NAMESPACE: default
STATUS: deployed
REVISION: 1
NOTES:
...
Key                Value
---                -----
created_time       2024-04-30T17:57:54.079267057Z
custom_metadata    <nil>
deletion_time      n/a
destroyed          false
version            1
...
```
tanmay@tanmay-ubuntu:~/Tanmay/Courses/Devops/S24-core-course-labs/k8s$ kubectl get po
NAME                                         READY   STATUS    RESTARTS   AGE
app-python-helm-app-python-76d4685d8-6qsm5   2/2     Running   0          47s
vault-0                                      1/1     Running   0          61m
vault-agent-injector-dbfc5cd77-n5ptr         1/1     Running   0          61m

tanmay@tanmay-ubuntu:~/Tanmay/Courses/Devops/S24-core-course-labs/k8s$ kubectl exec app-python-helm-app-python-76d4685d8-6qsm5 -- cat /vault/secrets/database-config.txt
Defaulted container "helm-app-python" out of: helm-app-python, vault-agent, vault-agent-init (init)
data: map[password:my-secret-pass username:myuser]
metadata: map[created_time:2024-04-30T17:57:54.079267057Z custom_metadata:<nil> deletion_time: destroyed:false version:1]
```
