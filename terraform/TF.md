...
aws_instance.app_server: Creation complete after 47s [id=i-0fe857fc44804c778]

Apply complete! Resources: 1 added, 0 changed, 0 destroyed.

Outputs:

aws-instance-app-server-id = "i-0fe857fc44804c778"
```
## `terraform state list` output
...
## `terraform state show aws_instance.app_server` output

```
# aws_instance.app_server:
resource "aws_instance" "app_server" {
    ami                                  = "ami-830c94e3"
    arn                                  = "arn:aws:ec2:us-west-2:767398008935:instance/i-0fe857fc44804c778"
    ...
    primary_network_interface_id         = "eni-071904372f307f368"
    private_dns                          = "ip-172-31-28-223.us-west-2.compute.internal"
    private_ip                           = "172.31.28.223"
    public_dns                           = "ec2-35-165-131-135.us-west-2.compute.amazonaws.com"
    public_ip                            = "35.165.131.135"
    ...
    root_block_device {
        ...
        tags                  = {}
        throughput            = 0
        volume_id             = "vol-0c0d410abf066b8c8"
        volume_size           = 8
...
# BEST PRACTICES
- Explicitly defined the provider with its source and version
- Declared resources , specifying the necessary attributes
- Used variables, allowing for flexibility and reusability of Terraform configurations
- Defined outputs