...
Changes to Outputs:
  + aws-instance-app-server-id = (known after apply)
...
aws_instance.app_server: Creation complete after 1m8s [id=i-017f4b5ca6d6b936b]

Apply complete! Resources: 1 added, 0 changed, 0 destroyed.

Outputs:

S24-core-course-labs/terraform/aws on  lab4 [?] via 💠 default took 1m29s
❯ terraform apply
aws_instance.app_server: Refreshing state... [id=i-017f4b5ca6d6b936b]
...
aws-instance-app-server-id = "i-017f4b5ca6d6b936b"
```
### `terraform state list` 
...
resource "aws_instance" "app_server" {
    ami                                  = "ami-830c94e3"
    arn                                  = "arn:aws:ec2:us-west-2:767398008935:instance/i-017f4b5ca6d6b936b"
    ...
    primary_network_interface_id         = "eni-0cb5f6374e44ed2c6"
    private_dns                          = "ip-172-31-22-223.us-west-2.compute.internal"
    private_ip                           = "172.31.22.223"
    public_dns                           = "ec2-54-212-230-234.us-west-2.compute.amazonaws.com"
    public_ip                            = "54.212.230.234"
    secondary_private_ips                = []
    security_groups                      = [
        "default",
    ]
    source_dest_check                    = true
    subnet_id                            = "subnet-039272df942494880"
    tags                                 = {
        "Name" = "ExampleAppServerInstance"
    }
    tags_all                             = {
    ...
    root_block_device {
        ...
        tags                  = {}
        throughput            = 0
        volume_id             = "vol-092142e915a4040c5"
        volume_size           = 8
...
# BEST PRACTICES
- Clearly specified the provider, including its source and version
- Stated resources and outlined essential attributes
- Employed variables to enhance flexibility and reusability in Terraform - configurations
- Established outputs